all = {
    "join" : {
        ...
        "notfound" : ("What courage; what ENTHUSIASM! You wish to join the game! ...And yet, you have not given me a name "
                      "by which to call you!\n\n`Usage: $join <name>`"),
        "exists" : ("You're already playing the game!")
    },
    "name" : {
        "notfound" : ("If you'd like to change your name, you'll need to fill out everything correctly! :kissing_heart:\n\n"
                       "`Usage: $name <new_name>`"),
